...
public class AI 
{
    ...
    /**
    * Method invoked when AI needs to respond to Action cards requiring it's participation.
    * @param card The card to respond to.
    * @return playableCards The list of cards to show.
    */
    public void aiRespond(ActionCard card) { // void for sake of complitation w/pseudocde. should return a List
    ...
    */
    ...
    public Card aiRefuteSuggestion(SuspectCard sc, VehicleCard vc, DestinationCard dc) {
    ...
    /**
    * Method invoked each time AI plays a turn in order to determine whether or not
    * to make an accusation based on the AI difficulty level.
    * @return boolean Returns true if accusation has been made, false if it hasn't. 
    */
    private void aiMakeAccusation() { // void for sake of complitation w/pseudocde. should return a boolean
