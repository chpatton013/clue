...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
     ...
     * reading thread except for
     * <pre>@codeClassNotFoundException</pre>s received when an object of
     * unknown class is received and for the
     * <pre>@codeRuntimeException</pre>s that can be thrown by the message
     * handling method implemented by the user.
     *
